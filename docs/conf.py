# -*- coding: utf-8 -*-
#
# py2p documentation build configuration file, created by
...
version = u'.'.join((str(x) for x in version_info[:2]))
# The full version, including alpha/beta/rc tags.
release = u'.'.join((str(x) for x in version_info))
